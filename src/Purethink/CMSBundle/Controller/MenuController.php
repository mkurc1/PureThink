...
use Purethink\CMSBundle\Form\MenuType;
...
class MenuController extends CRUDController
{
    ...
    {
        return $this->getDoctrine()->getRepository('PurethinkCMSBundle:Menu')
            ->getMenusQB($params['filter'], $params['languageId'], $params['groupId']);
    }

    protected function getListTemplate()
    {
        return 'PurethinkCMSBundle:Menu:_list.html.twig';
    }
    ...
    {
        return 'PurethinkCMSBundle:Menu:_new.html.twig';
    }

    protected function getEditFormTemplate()
    {
        return 'PurethinkCMSBundle:Menu:_edit.html.twig';
    }
    ...
    public function sequenceAction(Request $request)
    {
        ...
        foreach ($sequence as $value) {
            $entity = $em->getRepository('PurethinkCMSBundle:Menu')->find((int)$value['id']);
            $entity->setSequence((int)$value['sequence']);

            if (isset($value['parentId'])) {
                $entity->setMenu($em->getRepository('PurethinkCMSBundle:Menu')->find((int)$value['parentId']));
            } else {
                $entity->setMenu(null);
            }
        }
    ...
    public function stateAction(Request $request)
    {
        ...
        $entity = $this->getDoctrine()->getRepository('PurethinkCMSBundle:Menu')->find($id);
        if (!$entity) {
