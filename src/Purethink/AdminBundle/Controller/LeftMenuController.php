...
class LeftMenuController extends Controller
{
    ...
    public function menuAction(Request $request)
    {
        ...
        switch ($moduleId) {
            case 1:
                $CMSLeftMenuController = $this->get('purethink.cms.leftMenu.service');
    ...
    {
        $entities = $this->getDoctrine()->getRepository('PurethinkAdminBundle:Series')
            ->getGroupsByMenuId($menuId);

        return $this->renderView("PurethinkAdminBundle:LeftMenu:_groups.html.twig",
            compact('entities'));
    }
}
