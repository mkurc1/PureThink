...
use My\AdminBundle\Entity\Series;
...
class SeriesController extends Controller
{
    ...
    public function addGroupAction(Request $request)
    {
        ...
        $menu = $em->getRepository('MyAdminBundle:Menu')->find($menuId);
    ...
    public function editGroupAction(Request $request)
    {
        ...
        $entity = $this->getDoctrine()->getRepository('MyAdminBundle:Series')->find($id);
        if (!$entity) {
    ...
    public function removeGroupAction(Request $request)
    {
        ...
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('MyAdminBundle:Series')->find($id);
